...
import org.usfirst.frc2974.PiyushOMatic.autonomous.*;
...
//        autonomousCommand = new ForwardForFeet(5);
    ...
    public void autonomousInit() {
    	...
    	MasterScheduler.reset();
    	autonomousCommand = MasterScheduler.getInstance();
    ...
    public void autonomousPeriodic() {
    	SmartDashboard.putData("Autonomous Commands Running",Scheduler.getInstance());
    	autonomousCommand = MasterScheduler.getInstance();
